                                                                                        ...
                                                                                        <table cellspacing="0" cellpadding="0">
                                                                                            <tr>
                                                                                                <td style="font-family: Geneva, Tahoma, Verdana, sans-serif; font-size: 16px; line-height: 22px; color: #555555; padding-top: 16px;" align="left">
                                                                                                    ...
                                                                                                    An on-demand delivery platform that provides you with dispatch riders at the click of a button.<br />
                                                                                                    <br />
                                                                                                    With <b>Qwiki</b>, we plan to change the delivery scene by offering safe and secure deliveries across the Port Harcourt metropolis.
                                                                                                    If you haven’t already, connect with us on social media to be a part of this movement.<br />
                                                                                                    <br />
                                                                                                    <b>Wondering who <b>Qwiki</b> is for? Well, It is for people who;</b><br />
                                                                                                    <br />
                                                                                                    love swift deliveries<br />
                                                                                                    are tired of giving directions to dispatch riders<br />
                                                                                                    love affordable delivery rates<br />
                                                                                                    need to know the exact location of the rider and package at every point in time.<br />
                                                                                                    <br />
